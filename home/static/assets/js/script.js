...
$("body").append('<div class="fixed-button active"><a  href="javascript:void(0);"  class="btn-sm btn-primary"><i class="" aria-hidden="true"></i><i class="fas fa-plus-circle"></i></a></div>');
var $window = $(window),
    nav = $(".fixed-button");